...
public class Calendar extends JPanel {
	...
	private void highlightIfHasEvent(int cell) {
		...
		if(Database.getHostByID(calendarOf) != null && !calReservesEvent) { // aka is this a host && not a searched calendar
			...
			for(String s : d) {
				LocalDate eventDate = LocalDate.parse(s, DateTimeFormatter.ISO_LOCAL_DATE);
				if(today.getYear() == eventDate.getYear() && today.getMonthValue() == eventDate.getMonthValue() && today.getDayOfMonth() == eventDate.getDayOfMonth()) {
